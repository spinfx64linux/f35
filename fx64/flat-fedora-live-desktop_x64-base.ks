...
repo --name="fedora" --mirrorlist=https://mirrors.fedoraproject.org/metalink?repo=fedora-35&arch=$basearch --cost=20
repo --name="updates" --mirrorlist=https://mirrors.fedoraproject.org/metalink?repo=updates-released-f35&arch=$basearch --cost=30

repo --name="rf" --mirrorlist=http://mirrors.rpmfusion.org/mirrorlist?repo=free-fedora-35&arch=$basearch --cost=40
repo --name="rfu" --mirrorlist=http://mirrors.rpmfusion.org/mirrorlist?repo=free-fedora-updates-released-35&arch=$basearch --cost=50

repo --name="rn" --mirrorlist=http://mirrors.rpmfusion.org/mirrorlist?repo=nonfree-fedora-35&arch=$basearch --cost=60
repo --name="rnu" --mirrorlist=http://mirrors.rpmfusion.org/mirrorlist?repo=nonfree-fedora-updates-released-35&arch=$basearch --cost=70
...
/usr/bin/rpm --import /etc/pki/rpm-gpg/RPM-GPG-KEY-fedora-35-x86_64
/usr/bin/rpm --import /etc/pki/rpm-gpg/linux_signing_key.pub
/usr/bin/rpm --import /etc/pki/rpm-gpg/RPM-GPG-KEY-rpmfusion-free-fedora-35
/usr/bin/rpm --import /etc/pki/rpm-gpg/RPM-GPG-KEY-rpmfusion-nonfree-fedora-35
